...
VALUES (8928, 0,   9,   512, 4, 'You can only apply this augmentaion to a breastplate-slot item!') /* ValidLocations - ChestArmor */
	 ...
	 , (8928, 0, 384,     1, 3, 'This item has already been imbued!') /* Target.GearPKDamageResistanceInt - GreaterThanEqual 1 */;

INSERT INTO `recipe_mod` (`recipe_Id`, `executes_On_Success`, `health`, `stamina`, `mana`, `unknown_7`, `data_Id`, `unknown_9`, `instance_Id`)
VALUES (8928, True, 0, 0, 0, False, 0, 1, 0) /* Mutation Filter - Viridian Armor Augmentations */;
